...
ADNI_table = get_src_table(path = "/Users/shijia.zhang/Desktop/archiv 1/Archive/ADNI/ADMerge/data/ADNI Demonstration",
                           ID_usr_list = c("RID"),
...
plot_files(path = "ADNI Demonstration", dict_src = ADNI_table, study_type = "ADNI",date_type = "Date", plot_height = 1000) 
```
