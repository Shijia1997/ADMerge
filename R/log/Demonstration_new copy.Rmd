...
ADNI_table = get_src_table(path = "ADNI_demonstration_multi_site",
                           ...
                           IS_overlap_list = c("FALSE","FALSE","FALSE","TRUE","FALSE","FALSE","FALSE","FALSE","FALSE"),
                           WINDOW_list = c(366,366,366,1830,366,366,366,366,366))

ADNI_table

adni_plot_files = plot_files(path = "ADNI_demonstration_multi_site", dict_src = ADNI_table, study_type = "ADNI",date_type = "Date") 



htmltools::save_html(
  adni_plot_files,
  file = "adni_plot_files.html",
  libdir = "lib_adni"
)
```
...
ADNI_table = get_src_table(path = "ADNI_demonstration_multi_site",
                           ...
                           DATE_usr_list = c("EXAMDATE","VISDATE","SCANDATE"),
                           non_longitudinal_list = c("APOERES_ADNI_1_2_3"),
                           IS_overlap_list = c("FALSE","FALSE","FALSE","TRUE","FALSE","FALSE","FALSE","FALSE","FALSE","FALSE"),
                           WINDOW_list = c(366,366,366,1830,366,366,366,366,366,366))

ADNI_table

plot_files(path = "ADNI_demonstration_multi_site", dict_src = ADNI_table, study_type = "ADNI",date_type = "Date") 

ADNI_merged = ad_merge(path = "ADNI_demonstration_multi_site",
DATE_type = "Date",
...
htmltools::save_html(biocard_plot_files, file = "biocard_plot_files.html", libdir = "lib")

class(biocard_plot_files)
```
...
BIOCARD_table
library(jsonlite)
cat(toJSON(BIOCARD_table, pretty = TRUE, auto_unbox = TRUE))
# ==== 0. 加载必要包 ====
library(dplyr)
library(survival)
library(survminer)
